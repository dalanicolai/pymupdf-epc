;;; doc-pymupdf-epc-client.el --- Manipulate pdf files with doc-pymupdf-epc-server  -*- lexical-binding: t; -*-
...
(defcustom doc-pymupdf-epc-executable "doc-pymupdf-epc-server.py"
...
(defun doc-pymupdf-epc-structured-text (&optional detail start-page end-page)
  (let ((buffer (current-buffer)))
    (deferred:$
     (epc:call-deferred doc-pymupdf-epc-server
			'structured_text
			(list (or start-page 0) end-page (if detail (symbol-name detail))))
     (deferred:nextc it
...
(provide 'doc-pymupdf-epc-client)
;;; doc-pymupdf-epc-client.el ends here
